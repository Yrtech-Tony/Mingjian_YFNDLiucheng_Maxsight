    ...
    public partial class AnswerSubjects : BaseForm
    {
        ...
        public bool RecheckStatus()
        {
                ...
                )
            {
                ...
                txtPhotoScore.Enabled = false;
                txtSimutionScore.Enabled = false;
            ...
            else
            {
                ...
                chkNotinvolved.Enabled = true;
                txtRemark.Enabled = true;
                txtPhotoScore.Enabled = true;
                txtSimutionScore.Enabled = false;
                btnRecheckApply.Enabled = true;
                return false;
            }
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            if (ScoreCheck && !chkNotinvolved.Checked)
            {
                if (dsFullScore.Tables[0].Rows.Count > 0)
                {
                    if (dsFullScore.Tables[0].Rows[0]["FullScore"] != DBNull.Value)
                        fullScore = (decimal)dsFullScore.Tables[0].Rows[0]["FullScore"];
                }

                if (string.IsNullOrEmpty(txtScore.Text) && !chkNotinvolved.Checked)
                {
                    CommonHandler.ShowMessage(MessageType.Information, "体系得分不能为空");
                    return;
                }
                if (!string.IsNullOrEmpty(txtPhotoScore.Text))
                {
                    if (!string.IsNullOrEmpty(txtPhotLowestScore.Text) && Convert.ToDecimal(txtPhotoScore.Text) < Convert.ToDecimal(txtPhotLowestScore.Text))
                    {
                        CommonHandler.ShowMessage(MessageType.Information, "照片得分不应小于最低分值");
                        txtPhotoScore.Focus();
                        return;
                    }
                    if (!string.IsNullOrEmpty(txtPhotoFullScore.Text) && Convert.ToDecimal(txtPhotoScore.Text) > Convert.ToDecimal(txtPhotoFullScore.Text))
                    {
                        CommonHandler.ShowMessage(MessageType.Information, "照片得分不应大于于最高分值");
                        txtPhotoScore.Focus();
                        return;
                    }
                }
                if (!string.IsNullOrEmpty(txtScore.Text) && !chkNotinvolved.Checked)
                {
                    if (!string.IsNullOrEmpty(txtLowestScore.Text) && Convert.ToDecimal(txtScore.Text) < Convert.ToDecimal(txtLowestScore.Text))
                    {
                        CommonHandler.ShowMessage(MessageType.Information, "体系得分不应小于最低分值");
                        txtScore.Focus();
                        return;
                    }
                    if (!string.IsNullOrEmpty(txtFullScore.Text) && Convert.ToDecimal(txtScore.Text) > Convert.ToDecimal(txtFullScore.Text))
                    {
                        CommonHandler.ShowMessage(MessageType.Information, "体系得分不应大于最高分值");
                        txtScore.Focus();
                        return;
                    }
                }
            ...
            service.SaveAnswer(ProjectCode_Golbal, SubjectCode_Golbal, ShopCode_Golbal,
                            ...
                            CheckType, passReCheck, DateTime.Now.ToString("yyyy-MM-dd"), DateTime.Now.ToString("yyyy-MM-dd"), txtPhotoScore.Text);
            ...
            {
                if (dto.LossName == null)
                    dto.LossName = "";
                if (!string.IsNullOrEmpty(dto.LossName) && dto.LossName.Substring(dto.LossName.Length - 1, 1) == ";")
                {
                    dto.LossName = dto.LossName.Substring(0, dto.LossName.Length - 1);
                }
                service.SaveLossDesc(ProjectCode_Golbal, ShopCode_Golbal,txtShopName.Text.Trim(), SubjectCode_Golbal, dto.LossName, dto.PicName, dto.SeqNO, dto.StatusType, dto.SalesConsultantLoss);
            }
        ...
        public bool GetSubject(DataSet ds, ButtonType buttonType)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                subjectDto.ScoreCheck = Convert.ToBoolean(ds.Tables[0].Rows[0]["ScoreCheck"]);
                ...
                subjectDto.MemberType = Convert.ToString(ds.Tables[0].Rows[0]["MemberType"]);
                ...
                if (ds.Tables[0].Rows[0]["PhotoScore"] == DBNull.Value)
                {
                    subjectDto.PhoteScore = null;
                }
                else
                {
                    subjectDto.PhoteScore = Convert.ToDecimal(ds.Tables[0].Rows[0]["PhotoScore"]);
                }
                if (ds.Tables[0].Rows[0]["SimulationScore"] == DBNull.Value)
                {
                    subjectDto.SimulationScore = null;
                }
                else
                {
                    subjectDto.SimulationScore = Convert.ToDecimal(ds.Tables[0].Rows[0]["SimulationScore"]);
                }
                if (ds.Tables[0].Rows[0]["FullScore"] == DBNull.Value)
                {
                    subjectDto.FullScore = null;
                }
                else
                {
                    subjectDto.FullScore = Convert.ToDecimal(ds.Tables[0].Rows[0]["FullScore"]);
                }
                if (ds.Tables[0].Rows[0]["LowestScore"] == DBNull.Value)
                {
                    subjectDto.LowestScore = null;
                }
                else
                {
                    subjectDto.LowestScore = Convert.ToDecimal(ds.Tables[0].Rows[0]["LowestScore"]);
                }
                if (ds.Tables[0].Rows[0]["PhotoFullScore"] == DBNull.Value)
                {
                    subjectDto.PhotoFullScore = null;
                }
                else
                {
                    subjectDto.PhotoFullScore = Convert.ToDecimal(ds.Tables[0].Rows[0]["PhotoFullScore"]);
                }
                if (ds.Tables[0].Rows[0]["PhotoLowestScore"] == DBNull.Value)
                {
                    subjectDto.PhotoLowestScore = null;
                }
                else
                {
                    subjectDto.PhotoLowestScore = Convert.ToDecimal(ds.Tables[0].Rows[0]["PhotoLowestScore"]);
                }
                ...
                subjectDto.SubjectTypeCode = Convert.ToString(ds.Tables[0].Rows[0]["SubjectTypeCode"]);
            ...
            ScoreCheck = subjectDto.ScoreCheck;
            BindComBox.BindLoss(cboLoss, cboLoss2, cboLoss3, ProjectCode_Golbal, SubjectCode_Golbal);
            ...
            SubjectTypeCode = subjectDto.SubjectTypeCode;
            ...
            if (subjectDto.PhoteScore == null)
            {
                txtPhotoScore.Text = null;
            }
            else
            {
                txtPhotoScore.Text = subjectDto.PhoteScore.ToString();
            }
            if (subjectDto.SimulationScore == null)
            {
                txtSimutionScore.Text = null;
            }
            else
            {
                txtSimutionScore.Text = subjectDto.SimulationScore.ToString();
            }
            chkNotinvolved.Checked = false;
            if (subjectDto.Score == 9999 || !ScoreCheck)
            {
                chkNotinvolved.Checked = true;
            }
            else
            {
                if (subjectDto.Score == null)
                {
                    txtScore.Text = null;
                }
                else
            ...
            if (subjectDto.LowestScore == null)
            {
                txtLowestScore.Text = null;
            }
            else
            {
                txtLowestScore.Text = subjectDto.LowestScore.ToString();
            }
            if (subjectDto.FullScore == null)
            {
                txtFullScore.Text = null;
            }
            else
            {
                txtFullScore.Text = subjectDto.FullScore.ToString();
            }
            if (subjectDto.PhotoLowestScore == null)
            {
                txtPhotLowestScore.Text = null;
            }
            else
            {
                txtPhotLowestScore.Text = subjectDto.PhotoLowestScore.ToString();
            }
            if (subjectDto.PhotoFullScore == null)
            {
                txtPhotoFullScore.Text = null;
            }
            else
            {
                txtPhotoFullScore.Text = subjectDto.PhotoFullScore.ToString();
            }
            if (subjectDto.MemberType == "02")
            {
        ...
        public void GetLossDesc(string projectCode, string shopCode, string subjectCode)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    loss.SalesConsultantLoss = ds.Tables[0].Rows[i]["SalesConsultantLoss"].ToString();
        ...
        public List<string> GetLossDescSalesCosultant(string projectCode, string shopCode, string subjectCode)
        {
            DataSet ds = service.SearchSalesConsultantLossDesc(projectCode, shopCode, subjectCode);
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    if (!string.IsNullOrEmpty(ds.Tables[0].Rows[i]["LossDesc"].ToString()))
                    {
                        lossDesc += ds.Tables[0].Rows[i]["LossDesc"].ToString()+";";
                    }
                }
            }

            string[] str = lossDesc.Split(';');
            for (int i = 0; i < str.Length; i++)
            {
                if (!list.Contains(str[i]) && !string.IsNullOrEmpty(str[i]))
                {
                    list.Add(str[i]);
                }
            }
        ...
        public void GetSimulationScore()
        {
            DataSet ds = service.SearchSalesConsultantAvgScore(CommonHandler.GetComboBoxSelectedValue(cboProjects).ToString(), btnShopCode.Text.Trim(), txtSubjectCode.Text.Trim());
            if (ds.Tables[0].Rows.Count > 0)
            {
                if (ds.Tables[0].Rows[0]["avgScore"] == DBNull.Value)
                {
                    txtSimutionScore.Text = null;
                }
                else
                {
                    txtSimutionScore.Text = ds.Tables[0].Rows[0]["avgScore"].ToString();
                }
            }
            else
            {
        ...
        private void grvFileAndPic_ShowingEditor(object sender, CancelEventArgs e)
        {
            ...
            if ((RecheckStatus() 
                //|| cboProjects.SelectedIndex != 0
                ) && (grvFileAndPic.FocusedColumn == gcBrower || grvFileAndPic.FocusedColumn == gcDelete
                                    ))
            {
                e.Cancel = true;
            }
        ...
        private void btnPictureUpload_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            if (uploaddto.FilePath.Contains(':') && uploaddto.FilePath.Contains('\\'))
            {
                ...
                //    image = new byte[0];
                //}
                aliyun.PutObject("yrtech", "BENZ" + @"/" + CommonHandler.GetComboBoxSelectedValue(cboProjects).ToString() + txtShopName.Text + @"/" + SubjectCode_Golbal + @"/" + uploaddto.FileName + ".jpg", filePath);
        ...
        private void grcLoss_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (bdhi.InRow)
            {
                ...
                for (int i = 0; i < filenameList.Length; i++)
                {
                    ...
                    //    image = new byte[0];
                    //}
                    aliyun.PutObject("yrtech", "BENZ" + @"/" + CommonHandler.GetComboBoxSelectedValue(cboProjects).ToString() + txtShopName.Text + @"/" + SubjectCode_Golbal + @"/" + filenameList[i] + ".jpg", filePath);
        ...
        private void chkNotinvolved_CheckedChanged(object sender, EventArgs e)
        {
            if (chkNotinvolved.Checked)
            {
                ...
                txtPhotoScore.Text = null;
                txtPhotoScore.Properties.ReadOnly = true;

                txtSimutionScore.Text = null;
                txtSimutionScore.Properties.ReadOnly = true;
            }
            else
            {
                txtScore.Properties.ReadOnly = true;
                txtPhotoScore.Properties.ReadOnly = false;
                txtSimutionScore.Properties.ReadOnly = true;
            }
        }
        ...
        private void repositoryItemButtonEdit3_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            if (picname == null)
                picname = "";
            string[] picnamelist = picname.ToString().Split(';');
        ...
        {
            bool memberChk = chkMember.Checked;
            string memberType = "01";// 01：销售顾问 02:接待人员
            if(memberChk)
            {
                memberType = "02";
            }
            ...
            if (ScoreCheck)
            {
                GetSimulationScore();//销售顾问平均成绩
            }

            #region 添加失分描述

            List<string> salesConsultantLossDesc_list = GetLossDescSalesCosultant(CommonHandler.GetComboBoxSelectedValue(cboProjects).ToString(), btnShopCode.Text.Trim(), txtSubjectCode.Text.Trim());
            string salesConsultantLossDesc = "";

            for (int i = 0; i < salesConsultantLossDesc_list.Count; i++)
            {
                if (!string.IsNullOrEmpty(salesConsultantLossDesc_list[i]) && i != salesConsultantLossDesc_list.Count - 1)
                    salesConsultantLossDesc += salesConsultantLossDesc_list[i] + ";";
                else
                    salesConsultantLossDesc += salesConsultantLossDesc_list[i];
            }
            if (string.IsNullOrEmpty(salesConsultantLossDesc))
                return;
            //先删除 模拟类失分说明
            List<LossResultDto> inspectionList = grcLoss.DataSource as List<LossResultDto>;
            for (int i = 0; i < inspectionList.Count; i++)
            {
                if (inspectionList[i].SalesConsultantLoss == "02")
                {
                    grvLoss.DeleteRow(i);
                }
            }
            ...
            loss.LossName = salesConsultantLossDesc;
            loss.SalesConsultantLoss = "02";
            dataHandler3.AddRow(loss);
            #endregion
        }
        private void txtPhotoScore_TextChanged(object sender, EventArgs e)
        {
            if (string.IsNullOrEmpty(txtPhotoScore.Text) && string.IsNullOrEmpty(txtSimutionScore.Text))
            {
                return;
            }
            if (string.IsNullOrEmpty(txtPhotoScore.Text))
            {
                txtScore.Text = txtSimutionScore.Text;
            }
            if (string.IsNullOrEmpty(txtSimutionScore.Text))
            {
                txtScore.Text = txtPhotoScore.Text;
            }
            if (!string.IsNullOrEmpty(txtPhotoScore.Text) && !string.IsNullOrEmpty(txtSimutionScore.Text))
            {
                txtScore.Text = ((Convert.ToDecimal(txtPhotoScore.Text) + Convert.ToDecimal(txtSimutionScore.Text)) / 2).ToString();
            }
        }

        private void txtSimutionScore_TextChanged(object sender, EventArgs e)
        {
            if (string.IsNullOrEmpty(txtPhotoScore.Text) && string.IsNullOrEmpty(txtSimutionScore.Text))
            {
                return;
        ...
        private void grvLoss_ShowingEditor(object sender, CancelEventArgs e)
        {
            LossResultDto loss = grvLoss.GetRow(grvLoss.FocusedRowHandle) as LossResultDto;
            if (loss.SalesConsultantLoss == "02" && grvLoss.FocusedColumn == gridColumn2)
            {
                CommonHandler.ShowMessage(MessageType.Information, "此失分描述是销售顾问失分描述，请在销售顾问页面更改");
                e.Cancel = true;
            }
            else
            {
